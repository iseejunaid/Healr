  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.filesContainer}>
        ...
        />
        {
          files.length === 0 ? <View style={{height:450,width:'100%',justifyContent:'center',alignItems:'center'}}>
            <Image source={require('../../../assets/images/noFile.png')} />
            <Text style={{marginTop:'5%',fontFamily:Fonts.regular,color:Colors.tertiaryColor}}>Empty shelves! No files in sight.</Text>
          </View> : null
        }
